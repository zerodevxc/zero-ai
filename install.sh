...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/zerodevxc/thema/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/zerodevxc/thema/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
if [ "$SELECT_THEME" -eq 1 ]; then
  ...
  echo -e "                                                                   "
    ...
    echo -e "${YELLOW}Masukkan link wa (https://wa.me/6281997715124) : ${NC}"
    read LINK_WA
    echo -e "${YELLOW}Masukkan link group (https://.....) : ${NC}"
    read LINK_GROUP
    echo -e "${YELLOW}Masukkan link channel (https://whatsapp.com/channel/0029Vap02vn545up8TEb5l11) : ${NC}"
    read LINK_CHNL
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/zerodevxc/thema/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/zerodevxc/thema/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer ZeroDev Private   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/ext4you     ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : ZERO DEVELOPER ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by Zero Dev  ${NC}"
